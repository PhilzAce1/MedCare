    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          MedSkin AI <span className="text-blue-600">Medical bot</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          Join our community in making medication and skin treatment better
        </p>
        {!loggedIn ? (
          <Button
            onClick={login}
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        <FeatureCard
          ...
          description="Get AI-powered diagnoses for skin conditions and other health issues."
        />
        <FeatureCard
          icon={ArrowDownRightSquareIcon}
          title="Personalized Medications"
          description="Receive personalized medication recommendations based on your condition."
        />
        <FeatureCard
          icon={Heart}
          title="Comprehensive Health Support"
          description="Access general medical advice and answers to your health-related questions."
        />
      </section>
      {/* 
